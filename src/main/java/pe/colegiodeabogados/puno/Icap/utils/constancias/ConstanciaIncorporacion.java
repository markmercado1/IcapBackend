...
public class ConstanciaIncorporacion extends ConstanciasBase{
    ...
    public byte[] generarConstanciaDesdeCero(Long idOrden) throws IOException {
        ...
        String fechaIncorporacionSeguro = Optional.ofNullable(orden.getAgremiado())
                ...
                .map(this::formatearFechaConMesEnLetras)
        ...
        String texto = String.format(
                "Que, el Colegiado(a), %s, se encuentra inscrito en el Ilustre Colegio de Abogados de Puno bajo el número %s. " +
                        "El miembro de la orden se INCORPORÓ en la fecha, %s, conforme aparece en el padrón general al que nos remitimos " +
                        "en caso necesario para la confrontación de Ley. Se expide la presente constancia al interesado para los fines pertinentes. Otorgado en Puno a los %s.",
