...
public class ConstanciaSinSanciones extends ConstanciasBase{
    ...
    public byte[] generarConstanciaDesdeCero(Long idOrden) throws IOException {
        ...
        String texto = String.format(
                "Que el colegiado(a) %s se encuentra inscrito en el Ilustre Colegio de Abogados de Puno bajo el número %s, " +
                        ...
                        "Asimismo, se deja constancia que revisados los libros de registro correspondiente, el agremiado NO TIENE INSCRITA SANCIÓN VIGENTE, QUEJA O ALGÚN IMPEDIMENTO PARA EJERCER LA PROFESIÓN. " +
...
// Usar estas medidas en tu llamada
        ...
        escribirCentrado(content, "RECIBO N° " + texto1,
                fuenteNegrita, 16, x.apply(50f), y.apply(200f)); // Fijo a 5cm del borde inferior
